...
-- NOTE: END OF PERSONALISED CHANGES
...
require("lazy").setup({
  ...
  {
    -- TODO: Main LSP Configuration (To be updated)
  ...
  { -- Highlight, edit, and navigate code
    ...
    },
    {
      ...
      config = function()
        ...
        -- NOTE: Telescope Monorepo
        vim.keymap.set("n", "<leader>m", function()
          require("telescope").extensions.monorepo.monorepo()
        end, { desc = "[M]onorepo" })

        -- NOTE: MANAGAING PROJECTS
        vim.keymap.set("n", "<leader>ma", function()
          require("monorepo").add_project()
        end, { desc = "[M]onorepo [A]add Project" })

        vim.keymap.set("n", "<leader>mr", function()
          require("monorepo").remove_project()
        end, { desc = "[M]onorepo [R]emove Project" })

        vim.keymap.set("n", "<leader>mt", function()
          require("monorepo").toggle_project()
        end, { desc = "[M]onorepo [T]oggle Project" })

        -- NOTE: CHANGING PROJECTS
        vim.keymap.set("n", "<leader>mn", function()
          require("monorepo").next_project()
        end, { desc = "[M]onorepo [N]ext Project" })

        vim.keymap.set("n", "<leader>mp", function()
          require("monorepo").previous_project()
        end, { desc = "[M]onorepo [P]revious Project" })

        for i = 1, 9 do
          vim.keymap.set("n", "<leader>m" .. i, function()
            require("monorepo").go_to_project(i)
          end, { desc = "[M]onorepo [index] of Project" })
        end
      end,
